...
<%--    --------------------------------------------%>
            ...
            <div class="slidebar_indicator">
                <ul class="slidebar_indicator-list">
            ...
            <div class="slidebar_move-left">
                <i class="fa-solid fa-circle-chevron-left"></i>
            </div>
            <div class="slidebar_move-right">
...
<%--        ten san pham--%>
            <div class="product-name-cont">
                <p class="product-name">Sofa Băng Đẹp Đẳng Cấp Cho Căn Hộ KPN919</p>
            </div>

<%--        gia san pham--%>
            <div class="product-price-cont">
                <p class="product-price">1200000 <span>VND</span></p>
            </div>
...
<%--    mo ta chi tiet san pham--%>
    <div class="proDe_detail">
        ...
        <p class="detail_des">
            Kích thước : Chiều dài: 2m2 (Luôn luôn: Có đặt theo kích thước yêu cầu)<br/>
            Chất liệu : Da Công nghiệp nhập khẩu Hàn Quốc<br/>
            Khung sườn : Khung gỗ Dầu tự nhiên chống mối mọt, cong vênh (Qua quy trình dấy hiện đại 72H)<br/>
            Nệm (đệm) mousse : D55 theo tiêu chuẩn xuất khẩu. Kháng được vi khuẩn & kháng được nấm mốc, cho bạn một sự nâng đỡ tuyệt hảo ở mọi tư thế ngồi, không bị đau lưng và sảng khoái (có lò xo trợ nhún). Thứ tự tăng dần về chất lượng Nệm Mousse D25 > D40 > D55 > Cao su non thiên nhiên (48D là Mousse chỉ có ở sản phẩm Nhập Khẩu)<br/>
            Chân ghế : Theo bộ<br/>
            Tính năng nổi bật: Thiết kế lạ mắt trên thị trường, nguyên liệu nhập khẩu chính hãng. Chất liệu không bám bụi, vệ sinh lau chùi, nằm đọc sách thư giãn.<br/>
            Sản xuất: Thương hiệu Kim Phú (Sản phẩm xuất khẩu quốc tế)<br/>
            Bảo hành: 5 Năm Khung Sườn 5 Năm Nệm Mousse (Khung không gãy đổ mối mọt và Nệm mút không lỗi 1 đổi 1 mới chính hãng)<br/>
        </p>
    </div>
</div>
